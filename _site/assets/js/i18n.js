(function () {
  ...
  var translations = {
    en: {
      ...
      "menu.tag.4": "Seasonal",
      "menu.tag.5": "Limited Time Offer",
      "menu.tag.6": "Special Offer",
      "menu.tag.7": "Healthy Choice",
    ...
    pt: {
      ...
      "menu.tag.4": "Sazonal",
      "menu.tag.5": "Oferta por Tempo Limitado",
      "menu.tag.6": "Oferta Especial",
      "menu.tag.7": "Escolha Saudável",
