(function () {
  ...
  var translations = {
    en: {
      ...
      "menu.settingsTab": "Settings",
      "menu.contentTab": "Content",
      "menu.json": "JSON",
      "menu.saveDraft": "Save",
      ...
      "menu.templateIdPlaceholder": "e.g. classic",
      ...
      "menu.untitledItem": "Untitled item",
      "menu.missingName": "Missing name",
      "menu.done": "Done",
      "menu.discardChangesTitle": "Discard changes?",
      "menu.discardChangesMessage": "You have unsaved changes to this item. If you continue, they will be lost.",
      "menu.discardChangesConfirm": "Discard changes",
      "menu.price": "Price",
      "menu.tag": "Tag",
      "menu.tag.none": "None",
      "menu.tag.1": "New",
      ...
      "menu.diets": "Diets",
      "menu.diet.1": "Vegan",
      "menu.diet.2": "Vegetarian",
      "menu.diet.3": "Gluten-free",
      "menu.diet.4": "Lactose-free",
      "menu.diet.5": "Egg-free",
      "menu.diet.6": "Sugar-free",
      "menu.diet.7": "Caffeine-free",
      "menu.diet.8": "Alcohol-free",
      "menu.diet.9": "Low-carb",
      "menu.diet.10": "Low-fat",
      "menu.diet.11": "Low-salt",
      "menu.diet.12": "Low-sugar",
      "menu.diet.13": "Organic",
      "menu.diet.14": "Bio",
      "menu.diet.15": "Kosher",
      "menu.diet.16": "Raw",
      "menu.diet.17": "Spicy",
      ...
      "menu.youtubePlaceholder": "YouTube URL",
      "menu.addVideo": "+ Add video",
      "menu.removeVideo": "Remove video",
      "menu.images": "Images",
      ...
      "tenant.switchTenant.label": "Active tenant",
      "tenant.switchTenant.help": "Choose which tenant this page's actions apply to. The options come from your account's <code>custom:subtenants</code> claim and the selection is sent as the <code>sub-tenant</code> header.",
      "tenant.switchTenant.save": "Switch",
      "tenant.switchTenant.saved": "Switched ✓",
    ...
    pt: {
      ...
      "menu.settingsTab": "Configurações",
      "menu.contentTab": "Conteúdo",
      "menu.json": "JSON",
      ...
      "menu.menuInfo": "Informações do cardápio",
      "menu.templateId": "ID do template",
      "menu.templateIdPlaceholder": "ex.: classic",
      ...
      "menu.untitledItem": "Item sem nome",
      "menu.missingName": "Nome em falta",
      "menu.done": "Concluído",
      "menu.discardChangesTitle": "Descartar alterações?",
      "menu.discardChangesMessage": "Você tem alterações não salvas neste item. Se continuar, elas serão perdidas.",
      "menu.discardChangesConfirm": "Descartar alterações",
      "menu.price": "Preço",
      "menu.tag": "Etiqueta",
      ...
      "menu.diets": "Dietas",
      "menu.diet.1": "Vegana",
      "menu.diet.2": "Vegetariana",
      "menu.diet.3": "Sem glúten",
      "menu.diet.4": "Sem lactose",
      "menu.diet.5": "Sem ovo",
      "menu.diet.6": "Sem açúcar",
      "menu.diet.7": "Sem cafeína",
      "menu.diet.8": "Sem álcool",
      "menu.diet.9": "Low-carb",
      "menu.diet.10": "Baixo teor de gordura",
      "menu.diet.11": "Baixo teor de sal",
      "menu.diet.12": "Baixo teor de açúcar",
      "menu.diet.13": "Orgânico",
      "menu.diet.14": "Bio",
      "menu.diet.15": "Kosher",
      "menu.diet.16": "Cru",
      "menu.diet.17": "Picante",
      ...
      "menu.youtubePlaceholder": "URL do YouTube",
      "menu.addVideo": "+ Adicionar vídeo",
      "menu.removeVideo": "Remover vídeo",
      "menu.images": "Imagens",
      ...
      "tenant.switchTenant.label": "Cliente ativo",
      "tenant.switchTenant.help": "Escolha para qual cliente as ações desta página se aplicam. As opções vêm da declaração <code>custom:subtenants</code> da sua conta e a seleção é enviada como o cabeçalho <code>sub-tenant</code>.",
      "tenant.switchTenant.save": "Alternar",
      "tenant.switchTenant.saved": "Alternado ✓",
