(function () {
  ...
  var translations = {
    en: {
      ...
      "menu.list.confirmDelete": "Delete this menu? It will no longer be accessible to customers.",
      ...
      "menu.confirmDelete": "Delete this menu? This cannot be undone from the UI.",
    ...
    pt: {
      ...
      "menu.list.confirmDelete": "Excluir este cardápio? Ele não estará mais acessível aos clientes.",
      ...
      "menu.confirmDelete": "Excluir este cardápio? Esta ação não pode ser desfeita pela interface.",
